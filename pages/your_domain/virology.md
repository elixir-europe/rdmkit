...
* FAIRsharing resources for metadata selection
  ...
  * Integrate epidemiological and genomic data for outbreak analysis, by utilizing phylodynamic workflows (e.g., BEAST, {% tool "nextstrain" %}, or TreeTime), enabling real-time outbreak tracking.
...
* Apply domain-specific vocabularies for consistent annotation
  * Utilize the [EVORA ontology](https://www.ebi.ac.uk/ols4/ontologies/evorao) and {% tool "ictv" %} to ensure that virus-related metadata terms are standardized and interoperable.
