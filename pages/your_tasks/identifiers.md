...
* Applying ontologies to variables keeps clear structure and relations between variables (i.e.,"compound & dose", "variable & unit") . Software that allow you to integrate ontology terms into a spreadsheet are: {% tool "rightfield" %} and {% tool "onotomaton" %}.
