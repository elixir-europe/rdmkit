...
* The genetic properties of a host are typically specified as part of a study where the host is modified or used to harbour a genetic construct. The description of the host can therefore be expanded from the taxonomic information to information about which genes have been inserted into the host genome, which genes have been mutated and the parental information about the strain.
