...
You can share your data with collaboration partners in the context of a collaborative research project, or you can publish your data to share it with the global research community and to society at large. 

It’s important to know that data sharing doesn’t mean open data nor public data. Data can also be shared with closed or restricted access. 
...
In a collaborative project, being able to easily share data make the research more efficient.
...
* If you are part of a collaborative research project, it is recommended to plan and establish in advance:
  ...
  * The use of storage solutions that guarantee shared, controlled and secured access to the data and proper data transfer.
...
* Based on the considerations listed above, you should be able to determine the right type of access for you data. Even if the access to the data is restricted, it is good practice to openly and publicly share the metadata of your data.
  ...
  * **Controlled access or Data Access Committees (DACs)**: data can only be shared with researchers, whose research is reviewed and approved by a Data Access Committee (DAC). DAC is an organization of one or more named individuals who are responsible for data release to external requestors based on specific criteria (research topics, allowed geographical regions, allowed recipients etc). Criteria established by DAC for data access are usually described on the website of the organization.
