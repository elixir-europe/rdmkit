...
* _{% tool "fair-checker" %} is currently beta-testing its functionality to give a biodiversity-community nuanced FAIR assessment; this involves assessing compliance to Bioschemas profiles which have been mapped to ENA checklists, primarily checklist 53 ([CL-53](https://www.ebi.ac.uk/ena/browser/view/ERC000053))_
