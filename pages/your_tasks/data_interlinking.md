...
* Start by creating BioSamples entries, if the technology-specific repositories don't do it for you: register parent samples and sub-samples (e.g. cohort-individual, individual-specimens, etc).
...
* A way to group all samples from your study under an overarching entry is to create a BioStudies entry describing your multi-omics study.
