...
The Norwegian Ministry of Education and Research's ["National strategy on access to and sharing of research data"](https://www.regjeringen.no/en/dokumenter/national-strategy-on-access-to-and-sharing-of-research-data/id2582412/?ch=1) from 2018 is an initiative aimed at fostering open, equitable, and efficient sharing of research data in Norway. At its core, the strategy aims to support researchers by establishing standards for management and curation of research data. The ministry encourages adoption of FAIR principles (making data findable, accessible, interoperable, and reusable), while ensuring data security and providing proper attribution to data creators. The strategy also provides guidelines for strengthening the infrastructure necessary for better data management practices and data sharing, recognising the importance of international cooperation. For researchers in Norway and their international partners, this strategy lays the groundwork for creating a robust, collaborative research environment where data is shared freely but responsibly. The national strategy underscores Norway's commitment to scientific advancement and maintaining ethical and legal standards in a data-driven era.
