...
- mzQuantML - a standard format that is intended to store the systematic description of workflows quantifying molecules (in principle peptides and proteins) by mass spectrometry.
