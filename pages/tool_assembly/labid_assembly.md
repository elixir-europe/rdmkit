...
- **Workflow Integration**: Keep track of workflow versions and workflow executions for platforms like {% tool "galaxy" %} or {% tool "nextflow" %}, and custom scripts. Import and export workflows from/to platforms like {% tool "workflowhub" %} and {% tool "git" %} repositories.
