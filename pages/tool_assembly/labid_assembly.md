...
- **Workflow Integration**: Keep track of workflow versions and workflow executions for platforms like {% tool "galaxy" %} or {% tool "nextflow" %}, and custom scripts. Import and export workflows from/to platforms like {% tool "workflowhub" %} and {% tool "git" %}-based platforms such as {% tool "github" %}, {% tool "gitlab" %}, and {% tool "bitbucket" %}.
...
The workflow integration of LabID was supported through the Open Science Clusters’ Action for Research and Society ([OSCARS](https://oscars-project.eu/)) European project under grant agreement Nº101129751.
