---
title: Identifiers
contributors: [Markus Englund, Flavio Licciulli, Nick Juty, Olivier Collin, Ulrike Wittig, Ivan Mičetić, Karel Berka, Shuxin Zhang, Hindrik Kerstens, Flora D'Anna, Yvonne Kallberg, Rob Hooft] 
...
* Local identifiers can be applied not only for individual records or observations in a dataset but also for each variable or even value ([columns and cells in a tabular dataset](https://datacarpentry.github.io/spreadsheet-ecology-lesson/01-format-data.html), respectively).
