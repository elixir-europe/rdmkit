...
The top folder should have a README.txt file describing the folder structure and what files are contained within the folders. For information on the content of README file see corresponding section on [Documentation and metadata](metadata_management#what-do-you-write-in-a-readme-file) page. See also [A Quick Guide to Organizing Computational Biology Projects](http://journals.plos.org/ploscompbiol/article?id=10.1371/journal.pcbi.1000424).
