...
* Tools and resources for data collection and management:
  ...
  * {% tool "fairsharing" %} is a manually curated registry of reporting guidelines, vocabularies, identifier scheme, models, formats, repositories, knowledge bases, and data policies that includes many resources relevant for managing plant phenotyping data.
