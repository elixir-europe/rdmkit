...
summary: Data management tool assembly from ELIXIR Luxembourg supporting projects in Translational Biomedicine. The TransMed assembly is available as a hosted service from ELIXIR Luxembourg, it is also a blueprint for the wider research community to use. 
tags: [transmed, compliance, collect, storage, process, metadata, interoperability, data organisation, data curation, data integration, data analysis, share]
---
