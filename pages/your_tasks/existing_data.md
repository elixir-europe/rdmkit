...
* Locate the repositories relevant for your field.
    ...
    * Search for research communities in the field, and find out whether they have policies for data submission that mention data repositories. For instance, {% tool "elixir-core-data-resourcess" %} [ELIXIR communities in Life Sciences](https://elixir-europe.org/communities).
